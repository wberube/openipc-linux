...
//-------------------------------------------------------------------------------------------------
#define SCATTER_DMA                 0 // 1:USE Scatter DMA Mode  0:USE CPU Mode
...
#define ETHTOOL_DEBUG               0 // eth status and the switch of flowctrol
#define NETWORK_STORM_PROTECT_DEBUG 0 // en debug nod
#define PHY_REGISTER_DEBUG          0 // en phy_r phy_w nod
#define PHY_LED_CTL                 0 // SW led ctrl
#define PHY_LED_INVERT              0 // invert led this define depend on PHY_LED_CTL
...
#define REG_ETH_EMAC1_h34      0x00000068
#define REG_ETH_EMAC1_h35      0x0000006A
