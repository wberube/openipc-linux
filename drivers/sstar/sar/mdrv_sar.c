...
static unsigned long _gMIO_MapBase = 0;
...
static int infinity_sar_probe(struct platform_device *pdev)
{
    ...
    _gMIO_MapBase = (unsigned long)sar->reg_base;
#ifdef CONFIG_CAM_CLK
...
static const struct of_device_id ms_sar_of_match_table[] = {{.compatible = "sstar,infinity-sar"}, {}};
