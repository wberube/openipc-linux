...
#define PWM_DBG 0
#if PWM_DBG
#define SSTAR_PWM_INFO(x, args...) printk(x, ##args)
#define SSTAR_PWM_DBG(x, args...)  printk(x, ##args)
#define SSTAR_PWM_ERR(x, args...)  printk(x, ##args)

#else
#define SSTAR_PWM_INFO(x, args...) printk(x, ##args)
#define SSTAR_PWM_DBG(x, args...)
#define SSTAR_PWM_ERR(x, args...) printk(x, ##args)
#endif
