...
+--------------------+---+---+-------------------------------------------------
*/
void msb250x_ep0_clr_opr_set_ss(void)
{
...
+--------------------+---+---+-------------------------------------------------
*/
int msb250x_ep_enable(struct usb_ep *_ep, const struct usb_endpoint_descriptor *desc)
{
...
+--------------------+---+---+-------------------------------------------------
*/
struct usb_request *msb250x_ep_alloc_request(struct usb_ep *_ep, gfp_t gfp_flags)
{
...
+--------------------+---+---+-------------------------------------------------
*/
void msb250x_ep_free_request(struct usb_ep *_ep, struct usb_request *_req)
{
    struct msb250x_ep *     ep  = to_msb250x_ep(_ep);
...
int msb250x_ep_queue(struct usb_ep *_ep, struct usb_request *_req, gfp_t gfp_flags)
{
    struct msb250x_request *req = to_msb250x_req(_req);
    struct msb250x_ep *     ep  = to_msb250x_ep(_ep);
    struct msb250x_udc *    dev = NULL;
...
+--------------------+---+---+-------------------------------------------------
*/
int msb250x_ep_dequeue(struct usb_ep *_ep, struct usb_request *_req)
{
    struct msb250x_ep *ep = to_msb250x_ep(_ep);
...
+--------------------+---+---+-------------------------------------------------
*/
int msb250x_ep_set_halt(struct usb_ep *_ep, int value)
{
    u8 csr    = 0;
    u8 ep_num = 0;
...
+--------------------+---+---+-------------------------------------------------
*/
static void msb250x_ep0_handle_idle(struct msb250x_udc *dev, struct msb250x_ep *ep)
{
    u8                     address = 0;
    int                    len = 0, ret = 0;
    ...
    if (sizeof(struct usb_ctrlrequest) != len)
    {
        printk(KERN_ERR
               ...
               " wanted %zu bytes got %d. Stalling out...\n",
...
+--------------------+---+---+-------------------------------------------------
*/
void msb250x_ep_isr_handler(struct msb250x_udc *dev, struct msb250x_ep *ep)
{
