...
#define BASE_REG_MIU_EFFI_PRE  GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x161600)
...
typedef enum
{
    MS_I6E_PACKAGE_UNKNOWN = 0x00,
    MS_I6E_PACKAGE_QFN_DDR3,
    MS_I6E_PACKAGE_BGA_LPDDR2,
    MS_I6E_PACKAGE_EXTENDED   = 0x30,
    MS_I6E_PACKAGE_BGA2_DDR3  = 0x30,
    MS_I6E_PACKAGE_FPGA_128MB = 0x90,
} MS_I6_PACKAGE_TYPE;
